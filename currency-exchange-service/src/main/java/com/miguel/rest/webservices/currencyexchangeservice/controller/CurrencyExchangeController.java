package com.miguel.rest.webservices.currencyexchangeservice.controller;

import com.miguel.rest.webservices.currencyexchangeservice.CurrencyExchange;
import com.miguel.rest.webservices.currencyexchangeservice.repository.CurrencyExchangeRepository;
...
//        CurrencyExchange currencyExchange = new CurrencyExchange(1000L, "USD", "INR", BigDecimal.valueOf(50));
        ...
        repository.findAll(); // return all the things from db
